    ...
    <div className="login-wrap">
      ...
      <div className="login-container">
        ...
        <div className="login-nav">
          <div onClick={() => setLoginType('mobile_code')} className={loginType == 'mobile_code' ? "nav-item active youshu-active" : "nav-item"}>验证码登录</div>
          <div onClick={() => setLoginType('mobile')} className={loginType == 'mobile' ? "nav-item active youshu-active" : "nav-item"}>密码登录</div>
        </div>
        <Form
          name="normal_login"
          form={form}
        ...
        >
          ...
          <Form.Item
            ...
            colon={false}
            shouldUpdate
            rules={[{ required: true, message: '请输入手机号!', max: 11 }, ({ getFieldValue }) => ({
              validator(_, e: any) {
          ...
          }
          {
            loginType == 'mobile_code' ?
              <div className="login-code">
                ...
                <p onClick={sendSMS} className={codeText == '获取验证码' ? "login-code-btn active active-youshu" : "login-code-btn"}>{codeText}</p>
              </div> : null
          }
